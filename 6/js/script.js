...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return setTypographyAnimation; });
class AccentTypographyBuild {
    ...
    createElement(letter) {
      ...
      span.style.transition = `${this._property} ${this._timer}ms ease ${this._timeOffset * Math.random()}ms`;
      this._timeOffset += 20;
      return span;
    }
  ...
  function setTypographyAnimation () {
    ANIMATION_TARGETS.forEach((target) => {
      let animationTarget = new AccentTypographyBuild(target, 500, `--active`, `transform`);
    })
  }
...
/* harmony import */ var _modules_accent_typography_build_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/accent-typography-build.js */ "./source/js/modules/accent-typography-build.js");
// modules
...
Object(_modules_accent_typography_build_js__WEBPACK_IMPORTED_MODULE_9__["default"])();
